...
<div class="row">
    <div class="col-lg-12">
        ...
        <g:form url="[resource: propertyName, action: 'update']"
                method="PUT" >
        <g:hiddenField name="version" value="${currencyRatesInstance?.version}"/>
        <fieldset class="form">
...
%{--<a href="#edit-currencyRates" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>--}%
...
%{--</ul>--}%
%{--</div>--}%
%{--<div id="edit-currencyRates" class="content scaffold-edit" role="main">--}%
%{--<h1><g:message code="default.edit.label" args="[entityName]" /></h1>--}%
%{--<g:if test="${flash.message}">--}%
%{--<div class="message" role="status">${flash.message}</div>--}%
%{--</g:if>--}%
...
%{--</ul>--}%
%{--</g:hasErrors>--}%
%{--<g:form url="[resource:currencyRatesInstance, action:'update']" method="PUT" >--}%
%{--<g:hiddenField name="version" value="${currencyRatesInstance?.version}" />--}%
%{--<fieldset class="form">--}%
%{--<g:render template="form"/>--}%
%{--</fieldset>--}%

...
<html>
	...
	<body>
		<a href="#edit-profileUser" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-profileUser" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:profileUserInstance, action:'update']" method="PUT"  enctype="multipart/form-data">

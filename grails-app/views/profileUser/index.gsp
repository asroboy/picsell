...
<div id="list-profileUser" class="content scaffold-list" role="main">
    ...
    <p>
        <a type="button" class="btn btn-outline btn-default"
           href="${createLink(controller: 'profileUser', action: 'create')}">Add</a>
    </p>
    <table class="table table-striped table-bordered table-hover">
        <thead>
        <tr>
            <g:sortableColumn property="namaDepan"
                              title="${message(code: 'profileUser.namaDepan.label', default: 'Nama Depan')}"/>

            <g:sortableColumn property="namaBelakang"
                              title="${message(code: 'profileUser.namaBelakang.label', default: 'Nama Belakang')}"/>

            <g:sortableColumn property="alamat"
                              title="${message(code: 'profileUser.alamat.label', default: 'Alamat')}"/>

            <g:sortableColumn property="kecamatan"
                              title="${message(code: 'profileUser.kecamatan.label', default: 'Kecamatan')}"/>

            <g:sortableColumn property="kotaKabupaten"
                              title="${message(code: 'profileUser.kotaKabupaten.label', default: 'Kota Kabupaten')}"/>

            <g:sortableColumn property="provinsi"
                              title="${message(code: 'profileUser.provinsi.label', default: 'Provinsi')}"/>
        ...
        <g:each in="${profileUserInstanceList}" status="i" var="profileUserInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${profileUserInstance.id}">${fieldValue(bean: profileUserInstance, field: "namaDepan")}</g:link></td>

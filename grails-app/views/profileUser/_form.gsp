...
<div class="fieldcontain ${hasErrors(bean: profileUserInstance, field: 'jenisKartuIdentitas', 'error')} form-group">
	...
	<g:select name="jenisKartuIdentitas" from="${profileUserInstance.constraints.jenisKartuIdentitas.inList}" value="${profileUserInstance?.jenisKartuIdentitas}" valueMessagePrefix="profileUser.jenisKartuIdentitas" noSelection="['': '']"  class="form-control"/>
...
<div class="fieldcontain ${hasErrors(bean: profileUserInstance, field: 'tglLahir', 'error')} required form-group">
	...
	<g:datePicker name="tglLahir" precision="day"  value="${profileUserInstance?.tglLahir}"  class="input-group date" />
...
<div class="fieldcontain ${hasErrors(bean: profileUserInstance, field: 'user', 'error')} required form-group">
	...
	<g:select id="user" name="user.id" from="${com.picsell.security.User.list()}" optionKey="id" required="" value="${profileUserInstance?.user?.id}" class="many-to-one form-control"/>

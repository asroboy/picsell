                    ...
                    <div class="card" style="margin-bottom: 15px; ">
                        <ul class="list-group list-group-flush">
                            <g:set var="bankAccount"
                                   value="${com.picsell.data.BankAccount.findByUser(userInstance)}"/>
                ...
                <div class="row" style="margin: 20px;">
                    ...
                    %{--<a href="${createLink(controller: 'profileUser', action: '')}">--}%
                        <g:set var="profilePicture"
                               value="${com.picsell.data.ImageFile.findByTableNameAndTableId("ProfileUser", userInstance?.id)}"></g:set>

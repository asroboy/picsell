...
<div class="container">
    <div class="row">
        <div class="col-lg-4">
            <div class="my-4 label-red">User Dashboard - Portfolio</div>
        </div>
        ...
        <div class="col-lg-8 align-self-center">
            <ul class="nav justify-content-end">
                ...
                <li class="nav-item  active">
                    <a class="nav-link"
                       href="${createLink(controller: 'dashboard', action: 'portfolio', id: userObject?.id)}">Portofolio</a>
                </li>
                <li class="nav-item align-self-center">
                    |
                </li>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="sub-part1" style="margin-bottom: 15px">Portfolio</div>

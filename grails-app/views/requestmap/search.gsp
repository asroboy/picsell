			...
			<s2ui:formContainer type='search' beanType='requestmap' height='350'>
				<s2ui:searchForm colspan='2'>
					<tr>
						...
						<td><g:textField class="form-control" name='url' size='50' maxlength='255' autocomplete='off' value='${url}'/></td>
					</tr>
					<tr>
						<td><g:message code='requestmap.configAttribute.label' default='Config Attribute'/>:</td>
						<td><g:textField class="form-control" name='configAttribute' size='50' maxlength='255' autocomplete='off' value='${configAttribute}'/></td>
					</tr>
					<g:if test='${hasHttpMethod}'>
					<tr>
						<td><g:message code='requestmap.httpMethod.label' default='HttpMethod'/>:</td>
						<td>
							<g:select class="form-control" name='httpMethod' from='${org.springframework.http.HttpMethod.values()}' value='${httpMethod}' noSelection="['null': 'All']"/>
						</td>
					</tr>
					</g:if>
				</s2ui:searchForm>

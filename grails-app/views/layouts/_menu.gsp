            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li><a href="${createLink(controller: 'requestmap', action: 'index')}"> Role Menu</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            %{--<a href="#">Pengumuman</a>--}%
                            <a href="${createLink(controller: 'pengumuman', action: 'index')}">Pengumuman</a>

                        </li>
                        <li>
                            <a href="${createLink(controller: 'ujian', action: 'index')}">Bahan Ujian</a>
                        </li>
                        <li>
                            <a href="${createLink(controller: 'pertemuan', action: 'index')}">Ujian Online</a>
                        </li>
                    </ul>
                </li>

...
class gsp_picsell_itemuserItems_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/item/userItems.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(4)
expressionOut.print(createLink(controller: 'item', action: 'itemDetail'))
printHtmlPart(5)
})

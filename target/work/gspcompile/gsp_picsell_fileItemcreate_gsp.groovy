...
class gsp_picsell_fileItemcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/fileItem/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'fileItem.label', default: 'FileItem'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',26,['bean':(fileItemInstance),'var':("error")],2)
printHtmlPart(14)
})
invokeTag('hasErrors','g',28,['bean':(fileItemInstance)],1)
printHtmlPart(7)
createTagBody(1, {->
printHtmlPart(15)
...
invokeTag('form','g',36,['url':([resource:fileItemInstance, action:'save']),'enctype':("multipart/form-data")],1)
printHtmlPart(18)
}

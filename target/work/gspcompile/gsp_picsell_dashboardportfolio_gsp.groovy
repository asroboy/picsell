...
class gsp_picsell_dashboardportfolio_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dashboard/portfolio.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1540620105483L

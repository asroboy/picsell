...
class gsp_picsell_testFilecreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/testFile/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'testFile.label', default: 'TestFile'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',26,['bean':(testFileInstance),'var':("error")],2)
printHtmlPart(14)
})
invokeTag('hasErrors','g',28,['bean':(testFileInstance)],1)
printHtmlPart(7)
createTagBody(1, {->
printHtmlPart(15)
...
invokeTag('form','g',36,['url':([resource:testFileInstance, action:'save']),'enctype':("multipart/form-data")],1)
printHtmlPart(18)
}

...
class gsp_picsell_dashboardpreferences_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dashboard/preferences.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1542541088665L

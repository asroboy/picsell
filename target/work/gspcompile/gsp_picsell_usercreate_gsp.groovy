...
class gsp_picsell_usercreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(userInstance),'var':("error")],2)
printHtmlPart(14)
})
invokeTag('hasErrors','g',28,['bean':(userInstance)],1)
printHtmlPart(7)
createTagBody(1, {->
printHtmlPart(15)
...
invokeTag('form','g',36,['url':([resource:userInstance, action:'save'])],1)
printHtmlPart(18)
}

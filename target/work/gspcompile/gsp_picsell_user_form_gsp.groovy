...
class gsp_picsell_user_form_gsp extends GroovyPage {
...
printHtmlPart(2)
invokeTag('textField','g',10,['name':("username"),'required':(""),'value':(userInstance?.username),'class':("form-control")],-1)
printHtmlPart(3)
...
printHtmlPart(2)
invokeTag('textField','g',19,['name':("password"),'required':(""),'value':(userInstance?.password),'class':("form-control")],-1)
printHtmlPart(3)
...
printHtmlPart(6)
invokeTag('checkBox','g',28,['name':("accountExpired"),'value':(userInstance?.accountExpired),'class':("form-control")],-1)
printHtmlPart(3)
...
printHtmlPart(6)
invokeTag('checkBox','g',37,['name':("accountLocked"),'value':(userInstance?.accountLocked),'class':("form-control")],-1)
printHtmlPart(3)
...
printHtmlPart(6)
invokeTag('checkBox','g',46,['name':("enabled"),'value':(userInstance?.enabled),'class':("form-control")],-1)
printHtmlPart(3)
...
printHtmlPart(6)
invokeTag('checkBox','g',55,['name':("passwordExpired"),'value':(userInstance?.passwordExpired),'class':("form-control")],-1)
printHtmlPart(10)
}

...
class gsp_picsell_dashboardadmin_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/dashboard/admin.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1533864311970L

...
printHtmlPart(11)
invokeTag('set','g',49,['var':("userRoles"),'value':(com.picsell.security.UserRole.findAllByUser(userObject))],-1)
printHtmlPart(12)
invokeTag('layoutHead','g',49,[:],-1)
printHtmlPart(2)
...
createTagBody(1, {->
printHtmlPart(14)
invokeTag('render','g',55,['template':("/layouts/menu")],-1)
printHtmlPart(15)
...
public static final long LAST_MODIFIED = 1538580377094L

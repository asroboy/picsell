...
class gsp_picsell_termOfServiceshow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/termOfService/show.gsp" }
public Object run() {
Writer out = getOut()
...
createTagBody(1, {->
printHtmlPart(5)
if(true && (termOfServiceInstance?.tos)) {
printHtmlPart(6)
...
public static final long LAST_MODIFIED = 1533748058777L

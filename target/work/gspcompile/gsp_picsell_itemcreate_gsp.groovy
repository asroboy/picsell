...
class gsp_picsell_itemcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(itemInstance),'var':("error")],2)
printHtmlPart(14)
})
invokeTag('hasErrors','g',28,['bean':(itemInstance)],1)
printHtmlPart(7)
createTagBody(1, {->
printHtmlPart(15)
...
invokeTag('form','g',36,['url':([resource:itemInstance, action:'save'])],1)
printHtmlPart(18)
}

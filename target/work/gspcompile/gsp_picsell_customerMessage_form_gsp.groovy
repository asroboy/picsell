...
class gsp_picsell_customerMessage_form_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/customerMessage/_form.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(2)
invokeTag('textField','g',10,['name':("fullName"),'value':(customerMessageInstance?.fullName),'class':("form-control")],-1)
printHtmlPart(3)
...
printHtmlPart(2)
invokeTag('textField','g',19,['name':("email"),'value':(customerMessageInstance?.email),'class':("form-control")],-1)
printHtmlPart(3)
...
public static final long LAST_MODIFIED = 1537720520670L

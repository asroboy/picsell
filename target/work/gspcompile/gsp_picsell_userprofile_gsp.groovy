...
class gsp_picsell_userprofile_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('set','g',66,['var':("bankAccount"),'value':(com.picsell.data.BankAccount.findByUser(userInstance))],-1)
printHtmlPart(13)
if(true && (bankAccount)) {
printHtmlPart(14)
...
printHtmlPart(28)
invokeTag('set','g',134,['var':("profilePicture"),'value':(com.picsell.data.ImageFile.findByTableNameAndTableId("ProfileUser", userInstance?.id))],-1)
printHtmlPart(29)
...
printHtmlPart(44)
invokeTag('message','g',209,['code':("testFile.foto.label"),'default':("Pick a picture")],-1)
printHtmlPart(45)
invokeTag('submitButton','g',217,['name':("create"),'class':("save btn btn-block btn-outline-success"),'value':(message(code: 'default.button.save.label', default: 'Save'))],-1)
printHtmlPart(46)
})
invokeTag('form','g',218,['url':([resource: profileUserInstance, action: 'saveProfileImage']),'enctype':("multipart/form-data")],2)
printHtmlPart(47)
...
public static final long LAST_MODIFIED = 1542186545134L

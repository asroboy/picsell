...
class gsp_picsell_profileUser_add_profile_info_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/profileUser/_add_profile_info.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(16)
invokeTag('submitButton','g',115,['name':("create"),'class':("save btn btn-sm btn-block btn-outline-success"),'value':(message(code: 'default.button.save.label', default: 'Save'))],-1)
printHtmlPart(17)
})
invokeTag('form','g',115,['url':([resource: profileUserInstance, action: 'saveProfileImage']),'enctype':("multipart/form-data")],1)
printHtmlPart(17)
}
...
public static final long LAST_MODIFIED = 1534927797230L

...
class gsp_picsell_homehelpCenter_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/home/helpCenter.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(3)
invokeTag('set','g',18,['var':("userRoles"),'value':(com.picsell.security.UserRole.findAllByUser(userObject))],-1)
printHtmlPart(3)
...
public static final long LAST_MODIFIED = 1533973894998L

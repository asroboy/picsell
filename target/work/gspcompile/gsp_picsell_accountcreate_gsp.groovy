...
invokeTag('eachError','g',26,['bean':(accountInstance),'var':("error")],2)
printHtmlPart(14)
})
invokeTag('hasErrors','g',28,['bean':(accountInstance)],1)
printHtmlPart(7)
createTagBody(1, {->
printHtmlPart(15)
...
invokeTag('form','g',36,['url':([resource:accountInstance, action:'save'])],1)
printHtmlPart(18)
}

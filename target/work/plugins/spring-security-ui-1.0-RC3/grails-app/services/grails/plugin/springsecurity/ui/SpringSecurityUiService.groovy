...
class SpringSecurityUiService implements AclStrategy, ErrorsStrategy, PersistentLoginStrategy,
    ...
    def createUser(RegisterCommand command) {
        uiPropertiesStrategy.setProperties(
                ...
                kecamatan: null,
                kotaKabupaten: null,
                jenisKartuIdentitas: null,
                nomorIdIdentitas: null,
                noTelp: null,
                tempatLahir: null,
                tglLahir: null,
                fotoProfile: null,
    ...
    Map<Class<?>, Map<String, String>> findClassMappings() {
        ...
        mappings[User] = [
                alamat             : userLookup.alamatPropertyName ?: '',
                kecamatan          : userLookup.kecamatanPropertyName ?: '',
                kotaKabupaten      : userLookup.kotaKabupatenPropertyName ?: '',
                jenisKartuIdentitas: userLookup.jenisKartuIdentitasPropertyName ?: '',
                nomorIdIdentitas   : userLookup.nomorIdIdentitasPropertyName ?: '',
                noTelp             : userLookup.noTelpPropertyName ?: '',
                tempatLahir        : userLookup.tempatLahirPropertyName ?: '',
                tglLahir           : userLookup.tglLahirPropertyName ?: '',
                fotoProfile        : userLookup.fotoProfilePropertyName ?: '',
                firstName          : userLookup.firstNamePropertyName ?: '',
                lastName           : userLookup.lastNamePropertyName ?: '',
